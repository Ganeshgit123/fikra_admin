...
@Component({
  selector: 'app-rules-banner',
  templateUrl: './rules-banner.component.html',
  styleUrls: ['./rules-banner.component.scss']
})
export class RulesBannerComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.rulesContent = this.formBuilder.group({
      bannerHeader: [''],
      bannerHeader_Ar: [''],
      bannerDescription: [''],
        ...
        (response: any) => {
          ...
          if (response.body.error == false) {
                this.imgUrl = response.body.data.Location
                    const data = this.rulesContent.value;
                  ...
                  var params1 = {
                  url: 'admin/postTopBannerSection_OurRule',
                  data: data
                  }
